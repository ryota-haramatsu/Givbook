...
@include('navbar')
        <form class="form-inline my-2 my-lg-0 d-flex justify-content-center" action="{{ url('books') }}" method="get">
            ...
            <button type="submit" class="btn btn-outline-dark btn-lg my-2 my-sm-0"><i class="fas fa-search"></i></button>
        </form>
    <!-- 検索結果 -->
    @if(isset($keyword))
        ...
        <div class="container">
            ...
            @foreach($books as $book)
                <div class="card col-md-3" style="max-width: 16rem;">
                    ...
                    <div class="card-body">
                        <button class="button mb-3"><a href="{{ route('chat') }}">メッセージを送る</a></button>
                        <!-- <button class="button mb-3"><a href="{{ url('books/'. $book->id. '/chat') }}">メッセージを送る</a></button> -->
                        <h5>コメント</h5>
